...
export const metadata: Metadata = { title: { template: "%s | ODNZ", absolute: "Facts and Myths | ODNZ" } };

const sidebarLinks = [
  { label: "Overview", href: "/facts-and-myths" },
  { label: "Statistics", href: "/facts-and-myths/statistics" },
  { label: "Myths", href: "/facts-and-myths/myths" },
  { label: "FAQs", href: "/facts-and-myths/faqs" },
];

export default function FactsAndMythsLayout({ children }: { children: React.ReactNode }) {
  return (
